...
//    {
//        if (!NetworkRunnerHandler.Ins.isStarted)
//            return;
//        Show();
//    }
...
//    {
//        Utils.Delay1Frame(() => inputField.ActivateInputField());
//    }
...
//            return;
//        }
//        RPC_RequireSendMessage($"[{NetworkRunnerHandler.Ins.namePlayer}]: {message}");
...
//            Utils.DelayCall(1f, () =>
//            {
//                NetworkRunnerHandler.Ins.networkChatSystem = this;
